...
class PessoasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pessoa" do
    assert_difference('Pessoa.count') do
      post pessoas_url, params: { pessoa: { login: @pessoa.login, nome: @pessoa.nome, senha: @pessoa.senha } }
    end
  ...
  test "should update pessoa" do
    patch pessoa_url(@pessoa), params: { pessoa: { login: @pessoa.login, nome: @pessoa.nome, senha: @pessoa.senha } }
